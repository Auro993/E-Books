	...
	<div class="container py-4">
		<div class="row">
			<div class="col-md-4">
				...
				<p>Your one-stop destination for digital books. Read anytime,
					anywhere.</p>
			</div>
			<div class="col-md-4">
				<h5>Quick Links</h5>
			...
			<div class="col-md-4">
				<h5>Contact Info</h5>
				<p>
					<i class="fas fa-envelope"></i> info@ebooks.com
				</p>
				<p>
				...
				<div class="social-links">
					<a href="#" class="text-white mr-3"><i
						class="fab fa-facebook-f"></i></a> <a href="#" class="text-white mr-3"><i
						class="fab fa-twitter"></i></a> <a href="#" class="text-white mr-3"><i
